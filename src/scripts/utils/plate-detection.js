...
const PlateDetection = {
  ...
  async _performOCR({ canvasImg }) {
    ...
    const {
      data: { text },
    } = await worker.recognize(canvasImg);
  ...
  async _detectPlateNumber({ imagePreview, tableWrapper, cascadeFile }) {
    ...
    // display text sedang memuat
    const divText = document.createElement("div");
    divText.innerHTML = "Memproses...";
    divText.classList.add("txt-loading");
    tableWrapper.appendChild(divText);
